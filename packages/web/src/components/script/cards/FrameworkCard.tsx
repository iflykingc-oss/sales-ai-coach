  ...
  return (
    <div className="mb-4 rounded-lg border border-violet-200 bg-violet-50 p-4">
      ...
      <div className="space-y-3">
        {Array.isArray(analysis.detectedFrameworks) && analysis.detectedFrameworks.length > 0 && (
          <div>
        ...
        {Array.isArray(analysis.frameworkStrengths) && analysis.frameworkStrengths.length > 0 && (
          <div>
        ...
        {Array.isArray(analysis.frameworkGaps) && analysis.frameworkGaps.length > 0 && (
          <div>
        ...
        {Array.isArray(analysis.suggestedFrameworks) && analysis.suggestedFrameworks.length > 0 && (
          <div>
