  ...
  return (
    <div className="mb-4 rounded-lg border border-rose-200 bg-rose-50 p-4">
      ...
      <div className="space-y-3">
        {Array.isArray(data.likely_pains) && data.likely_pains.length > 0 && (
          <div>
        ...
        {Array.isArray(data.hidden_needs) && data.hidden_needs.length > 0 && (
          <div>
        ...
        {Array.isArray(data.decision_factors) && data.decision_factors.length > 0 && (
          <div>
