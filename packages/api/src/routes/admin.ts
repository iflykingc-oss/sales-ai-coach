...
router.post('/users/:id/disable', async (req: AuthRequest, res, next) => {
  try {
...
router.post('/plugins', async (req: AuthRequest, res, next) => {
  try {
...
router.post('/train', async (req: AuthRequest, res, next) => {
  try {
